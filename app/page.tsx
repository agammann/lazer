...
export default function Home() {
  ...
  return <main className="lz">
    <header className="lz-header"><a href="/" className="lz-brand"><Zap size={30} fill="currentColor" />LAZER</a>
      ...
      <span className="lz-mode">Practice market</span><label className="lz-trader"><span>Trader</span><select aria-label="Active trader" value={trader} onChange={e => setTrader(e.target.value as Trader)}><option>Alice</option><option>Bob</option></select></label>
    </header>
    ...
    </> : panel === 'Funding' ? <section className="lz-panel lz-info"><h2>One trading account. Bitcoin funding choices.</h2><p>Lightning, Ark, and Liquid are the planned ways to fund and withdraw collateral. Trading happens in Lazer’s order book; you will not swap assets for every trade.</p><div className="lz-rails">{[
